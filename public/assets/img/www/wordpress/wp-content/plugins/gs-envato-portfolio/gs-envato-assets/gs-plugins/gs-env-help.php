...
add_action('admin_menu', 'gs_pin_help_menu');

function gs_env_help_menu_cb() {
	?>

    <div class="gsp-wrap">
        
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 10px; text-align: center;">
	        <h1>GS Envato Portfolio by GS Plugins</h1>
			<div class="help-link">
    			<a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsplugins.com/product/wordpress-envato-plugin" target="_blank">Plugin Home</a>
    			<a class="gstm-hlp-btn gstm-btn-2" href="http://envato.gsplugins.com" target="_blank">Live Demo</a>
    			<a class="gstm-hlp-btn gstm-btn-3" href="http://envato.gsplugins.com/documentation" target="_blank">Documentation</a>
    			<a class="gstm-hlp-btn gstm-btn-4" href="http://envato.gsplugins.com/documentation/#GS_Envato_Portfolio8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
            ...
            <div class="hire-ad">
                <h3>Hire Me</h3>
                <p>Hey, I'm Sarwar Zaman, a professional WordPress Theme & Plugin Developer with great expertise on Genesis Child Theme development. You can hire me for your projects.<br><br>Email : hello@gsplugins.com <br> Skype : samdani1997 <br> Recent Projects : <a href="https://www.gsplugins.com/recent-works/" target="_blank">Works</a></p>
            </div>
        ...
        <div class="gswps-admin-sidebar" style="width: 277px; float: left; margin-top: 10px;">
            <div class="postbox">
