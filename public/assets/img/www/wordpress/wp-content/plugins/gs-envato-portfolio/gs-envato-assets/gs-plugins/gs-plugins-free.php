...
if( ! class_exists( 'GSPlugins_instagram_free' ) ){
    
    class GSPlugins_instagram_free{
        ...
        public function __construct() {
            add_action( 'admin_menu', array( $this, 'gs_plugins_free_menu2' ) );
        }
        ...
        public static function get_instance() {
            if ( ! self::$_instance instanceof GSPlugins_instagram_free ) {
                self::$_instance = new GSPlugins_instagram_free();
            }
            
            return self::$_instance;
        }
                
        public function gs_plugins_free_menu2() {
            ...
            add_submenu_page( 
                ...
                'manage_options', 
                'gs-plugins-free', 
                array( $this, 'gsbooks_free_menu_cb' )
            );

            // add_submenu_page( 'gsp-main', 'GS Plugins', 'GS Plugins FREE', 'manage_options', 'gs-plugins-free', array($this, 'gsbooks_free_menu_cb')); 
            // add_submenu_page( 'gsp-main', 'GS Plugins', 'GS Plugins FREE', 'delete_posts', 'gs-plugins-free', array($this, 'gsbooks_free_menu_cb'));
        }
        
        public function gsbooks_free_menu_cb() { ?>	  
    ...
    $gsplugin_free = GSPlugins_instagram_free::get_instance();
}