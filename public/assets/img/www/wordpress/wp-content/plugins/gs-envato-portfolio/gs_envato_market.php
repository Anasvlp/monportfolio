 ...
 * Description:       	Best Responsive Envato plugin for Wordpress to display Envato portfolio. Display anywhere at your site using shortcode like [gs_envato theme="gs_envato_theme1"] & widgets. Check more shortcode examples and documentation at <a href="http://envato.gsplugins.com">GS Envato Portfolio PRO Demos & Docs</a>
 * Version:           	1.3.7
 * Author:       		GS Plugins
 ...
 * Defining constants
 */
if( ! defined( 'GSENVATO_VERSION' ) ) define( 'GSENVATO_VERSION', '1.3.7' );
...
require_once GSENVATO_FILES_DIR . '/gs-plugins/gs-plugins.php';
require_once GSENVATO_FILES_DIR . '/gs-plugins/gs-plugins-free.php';
...
require_once GSENVATO_FILES_DIR . '/gs-plugins/gs-env-help.php';
...
function gsenv_redirect() {
    if (get_option('gsenv_activation_redirect', false)) {
        ...
        if(!isset($_GET['activate-multi']))
        {
            ...
            wp_redirect("admin.php?page=gs-env-help");
        }
    }
}
